...
const BN_TEMPLATES = {
  fallback: 'সংক্ষেপে আপনার লক্ষণ বা বুকিং প্রয়োজন লিখুন (উদাহরণ: বুকে চাপ, বারংবার মাথাব্যথা, গর্ভাবস্থা ফলোআপ)। জরুরি হলে স্থানীয় সেবা দিন বা হটলাইন কল করুন। জরুরি হটলাইন নম্বর: ০১৭৭৭২৭৫৭২৮, ০১৯৯৬৬৪২৭৩১',
  ...
  closing: 'কোন ডাক্তারটি আপনার পছন্দ তা জানান অথবা বিস্তারিত বলুন যাতে আমি আলাদা সুপারিশ দিতে পারি। জরুরি ক্ষেত্রে স্থানীয় হটলাইন কল করুন। ০১৭৭৭২৭৫৭২৮, ০১৯৯৬৬৪২৭৩১'
};
...
async function buildLocalChatReply(message){
  ...
  if(!suggestions.length){
    const nonMedicalReply = prefersBangla
      ? 'এটি কোনো চিকিৎসা-বিষয়ক পরামর্শ নয়। আপনার রোগের ভিত্তিতে সঠিক ডাক্তার সাজেস্ট করা হবে—দয়া করে রোগের নাম উল্লেখ করুন।'
      : 'This is not medical advice. A suitable doctor will be suggested based on your condition — please mention the name of your illness.';
  ...
  const closing = 'Let me know which doctor works best or add more context if you’d like a different specialty. For urgent or emergency issues, call your local hotline immediately. Hotline numbers: 01777275728, 01996642731.';
...
app.get('/api/admin/bookings', authMiddleware, adminMiddleware, async (req, res)=>{
  try{
    ...
    const rows = await db.all(`
      SELECT b.*, u.name AS userName, d.name AS doctorName
      FROM bookings b
